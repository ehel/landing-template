          ...
          <div class="tile">
            <div class="tile is-parent is-vertical">
              <article class="tile is-child feature">
                <p class="title font-accident-two-medium is-uppercase is-size-5">SCSS source files</p>
                <p class="subtitle is-size-7 font-accident-two-normal has-text-info is-uppercase">
                  compiled CSS included</p>
                <div class="content">
                  <div class="icon extra-small">
                    <svg version="1.1" width="40%" height="100%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 547.8 410.6" enable-background="new 0 0 547.8 410.6" xml:space="preserve">
              ...
              <article class="tile is-child feature">
                <p class="title font-accident-two-medium is-uppercase is-size-5">Javascript written using ES6</p>
                ...
                <div class="content">
                  <div class="icon extra-small">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="40%" height="100%" viewBox="0 0 297.45 419.877" enable-background="new 0 0 297.45 419.877">
                      ...
                      <g>
                        <g>
                          <polygon fill="#FFFFFF" points="148.93,209.97 148.93,247.207 194.783,257.207 190.461,305.5 148.93,316.711 148.93,355.453 225.27,334.295 225.828,328.004 235.486,229.97"></polygon>
                          <polygon fill="#FFFFFF" points="224.926,142.736 148.586,121.578 148.586,160.32 224.967,181.838"></polygon>
                        </g>
                        <g>
                          <g>
                            <polygon fill="#EBEBEB" points="149.059,209.97 100.803,219.97 107.078,171.505 148.551,160.306 148.715,160.352 148.715,121.608 148.543,121.56 72.264,142.736 62.424,219.97 62.406,219.97 62.412,220.049 62.406,220.104 62.418,220.104 65.727,257.207 65.908,257.207 72.607,334.295 148.887,355.471 149.059,355.422 149.059,316.678 148.895,316.725 107.422,305.525 103.277,257.207 149.059,247.207"></polygon>
                          </g>
                        </g>
                      </g>
                      <g>
                        <polygon fill="#131313" points="201.42,15.547 176.732,15.547 202.406,43.406 202.406,56.666 149.523,56.666 149.523,41.141 175.193,41.141 149.523,13.281 149.523,0 201.42,0"></polygon>
                        <polygon fill="#131313" points="138.914,16.178 138.914,0 93.342,0 93.342,56.666 138.914,56.666 138.914,40.491 112.275,40.491 112.275,34.839 137.914,34.839 137.914,21.828 112.275,21.828 112.275,16.178"></polygon>
                      </g>
                      </svg>
                  </div>
...
<style lang="scss">
  .feature {
    ...
    &:hover {
      ...
      box-shadow: 0 12px 50px rgba(10, 10, 10, 0.03), 0 0 0 0px rgba(10, 10, 10, 0.1);
      .icon {
        svg {
          fill: hsl(204, 86%, 53%);
        }
