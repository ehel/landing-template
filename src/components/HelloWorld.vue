<template>
  <div>
    ...
    <section class="section">
      <div class="container has-text-centered">
        ...
        <div class="columns">
          ...
          <div class="column">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30%" height="30%" fill="url(#primary)">
            ...
            <p class="font-regular-normal is-size-7">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad asperiores dicta fugiat modi nam natus quasi recusandae repellendus ullam voluptate? Ad aspernatur consequatur dolores nulla obcaecati quasi reprehenderit similique suscipit.
            </p>
          </div>
          <div class="column">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30%" height="30%" fill="url(#primary)">
            ...
            <div class="tile">
              <div class="tile is-parent is-vertical">
                <article class="tile is-child notification">
                  <p class="title font-accident-two-medium">Feature</p>
                  <p class="subtitle font-accident-two-normal">Subtitle</p>
                  <div class="content">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda commodi dicta dolorem eaque ex excepturi exercitationem fuga.
                  </div>
                </article>
                <article class="tile is-child notification">
                  <p class="title font-accident-two-medium">Features</p>
                  <p class="subtitle font-accident-two-normal">Subtitle</p>
                  <div class="content">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda commodi dicta dolorem eaque ex excepturi exercitationem fuga.
                  </div>
            ...
            <article class="tile is-child notification">
              <div class="content font-accident-two-normal">
                ...
                <div class="content">
                  ...
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam dolor dolore nobis obcaecati, repellendus sapiente vero. Asperiores, blanditiis eos expedita magnam magni maxime modi molestias officiis quo, unde vitae, voluptatum.
                </div>
              </div>
            </article>
          </div>
    ...
    <section class="hero section is-light is-bold">
      <div class="container has-text-centered">
        <h1 class="title font-accident-two-light is-uppercase mb-35">Testemonials</h1>
        <h2 class="subtitle font-accident-two-normal small is-uppercase has-text-info">
          ...
          <div class="column is-half is-offset-one-quarter">
            <form action="#">
              <div class="control has-icons-left is-expanded">
                <div class="field">
                  <input type="email" value="" name="email" class="input is-flat required email" placeholder="email address">
                </div>
                <div class="field">
              ...
              <div class="control">
                <input type="submit" value="Subscribe" class="button is-info is-inverted is-outlined is-pulled-right">
              </div>
            </form>
          </div>
        </div>
