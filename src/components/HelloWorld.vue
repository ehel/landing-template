  ...
  <div>
        ...
        <div class="container">
          <div class="columns">
            <div class="column center-text-vertically">
              ...
              <a class="button is-primary is-inverted is-outlined">Get Started</a>
            </div>
            <div class="column">
    ...
    <section class="section">
      <div class="container has-text-centered">
        ...
        <h2 class="subtitle font-accident-two-normal small is-uppercase has-text-primary">
        ...
        <div class="columns">
          ...
          <defs>
            <linearGradient id="primary">
              <stop offset="5%" stop-color="#009e6c" />
        ...
        <div class="colums">
          <div class="column is-half is-offset-one-quarter">
            <form action="#">
              ...
              <div class="control">
                <input type="submit" value="Subscribe" class="button is-white is-outlined is-pulled-right">
              </div>
