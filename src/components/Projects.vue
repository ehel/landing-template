...
<style lang="scss">
  ...
  .project{
    ...
    overflow: hidden;
    box-shadow: 0 12px 20px rgba(10, 10, 10, 0.1), 0 0 0 0px rgba(10, 10, 10, 0.1);
    .content{
  ...
  .first-project{
    background: url("/static/imgs/social-feed.png");
  }
  .second-project{
    background: url("/static/imgs/post.png");
  }
  .third-project{
    background: url("/static/imgs/inbox.png");
  }
</style>
